...
#ifndef OUTPUT			// cpu cycle of output is cc+2  (cc-2 after INCR_CC(4))
#define	OUTPUT(A,B)		{ INCR_CC(4); handle_output(A,B); }
#endif

#ifndef INPUT			// cpu cycle of input is cc+2  (cc-2 after INCR_CC(4))
#define	INPUT(A,B)		{ INCR_CC(4); B = handle_input(A); }
#endif
